...
try:
    ...
    import logging
    def get_traced_logger(name):
        return logging.getLogger(name)

logger = get_traced_logger(__name__)

class CPUThrottler:
    """CPU throttling and yield management for heavy operations"""
    ...
    def __init__(self, config):
        ...
        logger.info(f"CPU throttler initialized - Yield: {self.yield_interval_ms}ms, "
